...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://www.facebook.com/JIBON.AHMED65')
logo = ("""
\033[1;91m   
╔═══╦╗─╔╦═══╦╗╔═╦═══╦═══╗
║╔══╣║─║║╔═╗║║║╔╣╔══╣╔═╗║
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[JIBON 🙂\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
